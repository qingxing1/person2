...
export class VisitStatsController {
  ...
  @ApiQuery({ name: 'period', required: false, enum: ['week', 'month', 'nine'], description: '时间段：week-7天，month-30天，nine-90天' })
  async getVisitTrend(@Query('period') period: string = 'week'): Promise<ResultData> {
