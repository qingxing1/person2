...
export class PersonalInfoEntity {
  ...
  @Column({
    type: "json",
    comment: '技术栈列表：["React", "TypeScript", "Node.js"]',
    nullable: true,
  })
  skills?: JSON;
  ...
  @Column({
    ...
    comment:
      '详细教育经历：[{"year":"2017-2021","degree":"本科","major":"计算机科学","school":"XX大学","description":"..."}]',
    nullable: true,
  })
  ...
  @Column({
    ...
    comment:
      '工作经历：[{"year":"2023-至今","position":"全栈工程师","company":"科技公司","description":"..."}]',
    nullable: true,
  })
  workExperience?: JSON;
  ...
  @Column({
    type: "json",
    comment:
      '项目经历：[{"title":"个人博客","description":"...","tech":["React","Node.js"],"link":"https://github.com/xxx"}]',
    nullable: true,
  })
  projects?: JSON;
  ...
  @Column({
    ...
    comment: "自我评价：描述个人优势、工作风格、职业理念等",
    nullable: true,
  })
